  ...
  <div class="row">
      <div class="col-sm-12">
          <div class="page-title-box">
              ...
              <h4 class="page-title">Data Transaksi rental Belum Lunas</h4>
          </div>
      </div>
  </div>
        ...
        <div class="card m-b-30">
          ...
          <div class="table-responsive">
            ...
            <h4 class="mt-0 header-title">
              ...
              <a href="?page=rental&aksi=rentalbelumlunas" class="btn btn-danger disabled">Status Belum Lunas</a>
            </h4>
            <table id="datatable" class="table table-bordered">
              ...
              $query = "SELECT * FROM `tb_rental` INNER JOIN `tb_pelanggan` ON `tb_rental`.`pelangganid` = `tb_pelanggan`.`pelangganid` INNER JOIN `tb_users` ON `tb_users`.`userid` = `tb_rental`.`userid` INNER JOIN `tb_jenis` ON `tb_jenis`.`kd_jenis` = `tb_rental`.`kd_jenis` WHERE `tb_rental`.`status_pembayaran` = 0";
